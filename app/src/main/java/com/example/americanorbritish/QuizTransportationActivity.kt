...
class QuizTransportationActivity : AppCompatActivity() {

    lateinit internal var quesList1: List<QuizTransportation>
    var score = 0
    internal var ctr1 = 1
    lateinit internal var currentQ1: QuizTransportation
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        quesList1 = db.getAllQuestions2(tableName)
        for (i in 0..9) {
            while (true) {
    ...
    fun showResult() {
        val intent = Intent(this@QuizTransportationActivity, ResultActivity::class.java)
        val b = Bundle()
